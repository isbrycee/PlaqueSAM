...
class PromptEncoder(nn.Module):
    ...
    def _embed_points(
        ...
        point_embedding = self.pe_layer.forward_with_coords( # (3, 2, 256)
    ...
    def forward(
        ...
        if points is not None:
            ...
            point_embeddings = self._embed_points(coords, labels, pad=(boxes is not None)) # changed by bryce
            sparse_embeddings = torch.cat([sparse_embeddings, point_embeddings], dim=1) # (3, 2, 256)
