...
class SAM2Base(torch.nn.Module):
    def __init__(
        ...
        # Temporal encoding of the memories; drop by bryce
    ...
    def _forward_sam_heads_MaskDNIO(
        self,
        backbone_features,
        point_inputs=None,
        mask_inputs=None,
        ...
        # outputs = self.sam_mask_decoder._forward_MaskDINO(
        outputs = self.sam_mask_decoder(
            image_embeddings=backbone_features,
            image_pe=self.sam_prompt_encoder.get_dense_pe(),
            sparse_prompt_embeddings=sparse_embeddings,
            dense_prompt_embeddings=dense_embeddings,
    ...
    def _prepare_memory_conditioned_features(
        ...
        if not is_init_cond_frame:
            ...
            for t_pos, prev in t_pos_and_prevs:
                ...
                # Temporal positional encoding; drop by bryce
                # maskmem_enc = (
    ...
    def _track_step(
        ...
        if mask_inputs is not None and self.use_mask_input_as_output_without_sam:
            ...
            # changed by bryce; !!!! note here !!!!; temporary drop it;
            # TODO; will be restore by changing to nn.embedding rather than torch.zero
            ...
            # sam_outputs = self._forward_sam_heads_MaskDNIO(
